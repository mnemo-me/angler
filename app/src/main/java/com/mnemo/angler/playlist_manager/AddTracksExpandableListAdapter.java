...
public class AddTracksExpandableListAdapter extends BaseExpandableListAdapter{
    ...
    ArrayList<String> artistChecked;
    ArrayList<String> mutedArtists;

    OnTrackCountChangeListener onTrackCountChangeListener;
    ...
    public AddTracksExpandableListAdapter(Context context, ArrayList<Track> tracksToAdd) {
