...
public class PlaylistArtistTracksFragment extends Fragment implements PlaylistArtistTracksView {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (!mainPlaylist.startsWith(getResources().getString(R.string.folder) + ": ")) {
            presenter.loadArtistTracksFromPlaylist(mainPlaylist, artist);
        }else{
            presenter.loadArtistTracksFromFolder(mainPlaylist.replace(getResources().getString(R.string.folder) + ": ", ""), artist);
        }
    }
