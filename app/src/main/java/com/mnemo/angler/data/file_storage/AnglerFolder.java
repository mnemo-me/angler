...
public class AnglerFolder {
    ...
    public static final String PATH_BACKGROUND_DEFAULT = PATH_BACKGROUND + File.separator + ".default";
    public static final String PATH_BACKGROUND_DEFAULT_PORTRAIT = PATH_BACKGROUND_DEFAULT + File.separator + "port";
    public static final String PATH_BACKGROUND_DEFAULT_LANDSCAPE = PATH_BACKGROUND_DEFAULT + File.separator + "land";
